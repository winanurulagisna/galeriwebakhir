...
<div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        ...
        <p class="mt-2 text-sm text-gray-700">Tulis artikel baru untuk blog</p>
    </div>

    <!-- Form -->
    <div class="bg-white shadow rounded-lg">
        <form action="{{ route('admin.posts.store') }}" method="POST" class="space-y-6 p-6">
            @csrf
            ...
            <div>
                ...
                <textarea name="content" id="content" rows="10" required
                          ...
                          placeholder="Tulis konten post Anda di sini...">{{ old('content') }}</textarea>
                @error('content')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
