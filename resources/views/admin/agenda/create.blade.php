...
@section('title', 'Tambah Agenda - Admin SMKN 4 KOTA BOGOR')
...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm p-6">
        <div class="mb-6">
            <h2 class="text-xl font-semibold text-gray-900">Tambah Agenda Baru</h2>
            <p class="text-gray-600">Isi form di bawah untuk menambahkan agenda sekolah baru</p>
        </div>
